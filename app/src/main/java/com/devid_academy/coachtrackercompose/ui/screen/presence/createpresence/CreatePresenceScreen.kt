...
@Composable
fun CreatePresenceScreen(
    navController: NavController,
    createPresenceViewModel: CreatePresenceViewModel,
    eventId: Int
) {
    val teamStateFlow by createPresenceViewModel.teamStateFlow.collectAsState()
    ...
    LaunchedEffect(true) {
        createPresenceViewModel.createPresenceSharedFlow.collect { event ->
            when (event) {
...
//        horizontalAlignment = Alignment.CenterHorizontally
        ...
        Row(
            ...
            Text(
                text = "Joueurs présents : ${selectedPlayers.value.size}",
